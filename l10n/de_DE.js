OC.L10N.register(
    ...
    "⚠ This app is still in early development\nand has only been tested with IBM watsonx.ai as a Service.\n\nThis app implements the following text generation providers\nusing any freely-available large language model:\nFree prompt, Summarize, Headline, Context Write, Chat, and Reformulate.\n\nYou can connect to the watsonx.ai service provided by IBM Cloud,\nor to a self-hosted cluster running IBM Software Hub and related services\n([IBM Cloud Pak for Data](https://www.ibm.com/docs/en/cloud-paks/cp-data/5.0.x) is also required in this case).\n\n## Improve AI task pickup speed\n\nTo avoid task processing execution delay, setup at 4 background job workers in the main server (where Nextcloud is installed).\nRefer to the [admin documentation](https://docs.nextcloud.com/server/latest/admin_manual/ai/overview.html#improve-ai-task-pickup-speed) for the setup process.\n\n## Ethical AI Rating\n\n### Rating for Text generation via IBM watsonx.ai: 🟠\n\nPositive:\n* The provided foundation models are freely available, and thus can be ran on-premises\n\nNegative:\n* The software for training and inference of models is proprietary, limiting modifications to the API or other functionality\n* Some foundation models are trained on data that is not freely available, limiting the ability to fine tune them\n\nLearn more about the Nextcloud Ethical AI Rating [in our blog](https://nextcloud.com/blog/nextcloud-ethical-ai-rating/)." : "⚠ Diese App befindet sich noch in der frühen Entwicklungsphase\nund wurde bisher nur mit IBM watsonx.ai as a Service getestet.\n\nDiese App implementiert die folgenden Textgenerierungsanbieter\nunter Verwendung eines beliebigen frei verfügbaren großen Sprachmodells:\nFree Prompt, Summarize, Headline, Context Write, Chat und Reformulate.\n\nSie können sich mit dem watsonx.ai-Service von IBM Cloud verbinden,\noder mit einem selbstgehosteten Cluster, auf dem IBM Software Hub und zugehörige Services ausgeführt werden.\n\n([IBM Cloud Pak for Data](https://www.ibm.com/docs/en/cloud-paks/cp-data/5.0.x) ist in diesem Fall ebenfalls erforderlich.)\n\n## Verbesserung der KI-Aufgabenbearbeitungsgeschwindigkeit\n\nUm Verzögerungen bei der Aufgabenverarbeitung zu vermeiden, richten Sie 4 Hintergrundprozesse auf dem Hauptserver (auf dem Nextcloud installiert ist) ein.\n\nInformationen zum Einrichtungsprozess finden Sie in der [Admin-Dokumentation](https://docs.nextcloud.com/server/latest/admin_manual/ai/overview.html#improve-ai-task-pickup-speed).\n\n## Bewertung ethischer KI\n\n### Bewertung für Textgenerierung mit IBM watsonx.ai: 🟠\n\nPositiv:\n* Die bereitgestellten Basismodelle sind frei verfügbar und können daher lokal ausgeführt werden.\n\nNegativ:\n* Die Software für das Training und die Inferenz der Modelle ist proprietär, was Änderungen an der API oder anderen Funktionen einschränkt.\n* Einige Basismodelle werden mit Daten trainiert, die nicht frei verfügbar sind, was die Feinabstimmung erschwert.\n\nErfahren Sie mehr über die Nextcloud-Bewertung ethischer KI [in unserem Blog](https://nextcloud.com/blog/nextcloud-ethical-ai-rating/).",
    ...
    "Username (mandatory)" : "Benutzername (erforderlich)",
    ...
    "You can create an API key in your IBM Cloud Pak for Data settings" : "Sie können einen API-Schlüssel in Ihren IBM Cloud Pak for Data-Einstellungen erstellen.",
    ...
    "Leave the username or API key empty to use the one defined by administrators" : "Das Feld für Benutzernamen oder API-Schlüssel leer lassen, um den von der Administration festgelegten Benutzernamen zu verwenden.",
