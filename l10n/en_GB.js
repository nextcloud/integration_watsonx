OC.L10N.register(
    ...
    "A username is required to authenticate to a self-hosted service (via IBM Cloud Pak for Data)" : "A username is required to authenticate to a self-hosted service (via IBM Cloud Pak for Data)",
    "API key (mandatory)" : "API key (mandatory)",
    ...
    "You can create an API key in your IBM Cloud Pak for Data settings" : "You can create an API key in your IBM Cloud Pak for Data settings",
    ...
    "Leave the username or API key empty to use the one defined by administrators" : "Leave the username or API key empty to use the one defined by administrators",
