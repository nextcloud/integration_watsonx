OC.L10N.register(
    ...
    "Username (mandatory)" : "Nome de usuario (obrigatorio)",
    "A username is required to authenticate to a self-hosted service (via IBM Cloud Pak for Data)" : "É necesario un nome de usuario para autenticarse nun servizo autoaloxado (a través de IBM Cloud Pak for Data)",
    "API key (mandatory)" : "Chave da API (obrigatoria)",
    ...
    "You can create an API key in your IBM Cloud Pak for Data settings" : "Pode crear unha chave API nos axustes de IBM Cloud Pak for Data",
    ...
    "Leave the username or API key empty to use the one defined by administrators" : "Deixe baleiro o nome de usuario ou a chave API para usar o definido pola administración da instancia",
