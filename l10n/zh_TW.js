OC.L10N.register(
    ...
    "Authentication" : "認證",
    "Username (mandatory)" : "使用者名稱（必填）",
    "A username is required to authenticate to a self-hosted service (via IBM Cloud Pak for Data)" : "需使用使用者名稱才能驗證至自行架設的服務（透過 IBM Cloud Pak for Data）",
    "API key (mandatory)" : "API 金鑰（必填）",
    "You can create an API key in your IBM Cloud IAM account settings" : "您可以在您的 IBM Cloud IAM 帳號設定中建立 API 金鑰",
    "You can create an API key in your IBM Cloud Pak for Data settings" : "您可以在 IBM Cloud Pak for Data 設定中建立 API 金鑰",
    ...
    "Leave the username or API key empty to use the one defined by administrators" : "將使用者名稱或 API 金鑰留空以使用管理員設定的",
