OC.L10N.register(
    ...
    "A username is required to authenticate to a self-hosted service (via IBM Cloud Pak for Data)" : "Un nombre de usuario es requerido para autenticarse a un servicio autoalojado (via IBM Cloud Pak for Data)",
    "API key (mandatory)" : "Clave API (obligatorio)",
    ...
    "You can create an API key in your IBM Cloud Pak for Data settings" : "Puedes crear una clave API en la configuración de tu IBM Cloud Pak for Data",
    ...
    "Leave the username or API key empty to use the one defined by administrators" : "Deja el nombre de usuario o clave API vacíos para usar los datos definidos por los administradores",
