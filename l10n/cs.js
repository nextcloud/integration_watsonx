OC.L10N.register(
    ...
    "You can create an API key in your IBM Cloud Pak for Data settings" : "Klíč k API je možné si vytvořit v nastavení vašeho IBM Cloud Pak for Data",
    ...
    "Leave the username or API key empty to use the one defined by administrators" : "Pokud chcete využít uživatelské jméno nebo klíč k API, definovaný správci, pak ho zde nevyplňujte",
